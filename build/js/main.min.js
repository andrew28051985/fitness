...
/* harmony import */ var _modules_slider_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/slider/slider */ "./js/modules/slider/slider.js");
...
/* harmony import */ var _modules_subscription_subscription__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/subscription/subscription */ "./js/modules/subscription/subscription.js");
/* harmony import */ var _utils_scroll_link__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/scroll-link */ "./js/utils/scroll-link.js");
/* harmony import */ var _modules_form_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form/form */ "./js/modules/form/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_scroll_link__WEBPACK_IMPORTED_MODULE_5__["scrollToLink"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_video_video__WEBPACK_IMPORTED_MODULE_3__["getVideo"])();
    Object(_modules_subscription_subscription__WEBPACK_IMPORTED_MODULE_4__["breakpointChecker"])();
    Object(_modules_subscription_subscription__WEBPACK_IMPORTED_MODULE_4__["subscriptionCard"])();
    Object(_modules_slider_slider__WEBPACK_IMPORTED_MODULE_2__["sliderCoaches"])();
    Object(_modules_slider_slider__WEBPACK_IMPORTED_MODULE_2__["sliderFeedback"])();
    Object(_modules_form_form__WEBPACK_IMPORTED_MODULE_6__["validityForm"])(_modules_form_form__WEBPACK_IMPORTED_MODULE_6__["inputPhoneContacts"], _modules_form_form__WEBPACK_IMPORTED_MODULE_6__["inputNameContacts"]);
    Object(_modules_form_form__WEBPACK_IMPORTED_MODULE_6__["sendUserFormData"])(_modules_form_form__WEBPACK_IMPORTED_MODULE_6__["contactsForm"]);
  });
}); // ---------------------------------
...
/*!*********************************!*\
  !*** ./js/modules/form/form.js ***!
  \*********************************/
/*! exports provided: validityForm, sendUserFormData, contactsForm, inputPhoneContacts, inputNameContacts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "contactsForm", function() { return contactsForm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inputPhoneContacts", function() { return inputPhoneContacts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inputNameContacts", function() { return inputNameContacts; });
/* eslint-disable no-undef */

/* eslint-disable no-unused-vars */
var validityInputNumber = /^[0-9]{1,10}$/;
var contactsSection = document.querySelector('.contacts');
var contactsForm = contactsSection.querySelector('form');
var inputPhoneContacts = contactsForm.querySelector('#phone');
var inputNameContacts = contactsForm.querySelector('#name');
...
/*!*************************************!*\
  !*** ./js/modules/slider/slider.js ***!
  \*************************************/
/*! exports provided: sliderCoaches, sliderFeedback */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sliderCoaches", function() { return sliderCoaches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sliderFeedback", function() { return sliderFeedback; });
...
var sliderCoaches = function sliderCoaches() {
  var swiperCoaches = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.mySwiper-coaches', {
    slidesPerView: 4,
    spaceBetween: 40,
    slidesPerGroup: 1,
    loop: true,
...
var sliderFeedback = function sliderFeedback() {
  var swiperFeedback = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.mySwiper-feedback', {
    slidesPerView: 1,
    spaceBetween: 40,
    slidesPerGroup: 1,
    loop: false,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "subscriptionCard", function() { return subscriptionCard; });
...
var tabs = subscription.querySelectorAll('.tabs__item');
var cards = subscription.querySelectorAll('.card__list');
...
var onCardSwitch = function onCardSwitch() {
  var isActiveTab = subscription.querySelector('.tabs__item--active');
  var isActiveCard = subscription.querySelector('.card--active');
...
var onTabsSwitch = function onTabsSwitch(tab) {
  var isActiveTab = subscription.querySelector('.tabs__item--active');
...
var switchTabs = function switchTabs() {
  tabs.forEach(function (tab) {
    ...
    tab.addEventListener('keydown', function (evt) {
      return isEnterKey(evt) ? onTabsSwitch(tab) : false;
    });
  });
};
...
var countButtonClick = function countButtonClick(evt) {
  var isButton = evt.target.classList.contains('btn');
  ...
  if (isButton && count === 0) {
    ...
    var newButton = evt.target.parentNode.childNodes[1].textContent;
    var newPrice = evt.target.parentNode.childNodes[5].textContent.replace(/[^0-9]/g, '');
...
var onClickButtonCard = function onClickButtonCard() {
  if (isMobile) {
...
var subscriptionCard = function subscriptionCard() {
  switchTabs();
};
...
var getVideo = function getVideo() {
  var controlVideo = document.querySelector('.gym__video-control');
  var player;
...
var link = mainScreen.querySelector('.btn--main');
